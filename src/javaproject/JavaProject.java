...
//    }
       ...
       String password;
        ...
        Book book2 = new Book("Title 2", "Author 2", "fiction 2");
...
//                    book.returnBook(bookToReturn);
         ...
         List<User> u=b.readFromFile(); 
                    ...
                    String borrowerNameToCancel = input.nextLine();
                    for(User i:u)
                    {
...
break;
          ...
          break;
           ...
           System.out.print("Enter the author's name: ");
            ...
            case 13:         
           System.out.println("Enter borrower's name to calculate payment (b1 or b2): ");
                    String borrowerNameToCalculatePayment = input.nextLine();
...
System.out.println("choose what do you want to addd this user as 1)Librarian or 2)Admin :");
